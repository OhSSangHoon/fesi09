      ...
      <main className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100">
        ...
        <section id="about" className="container mx-auto py-16">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="rounded-xl bg-white p-8 shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
              ...
              <div className="flex flex-row gap-x-2 cursor-pointer">
                <span className="rounded-full bg-indigo-100 px-3 py-1 text-indigo-800 hover:bg-indigo-200 transition-all duration-300 ease-in-out">
                  HTML
                </span>
                <span className="rounded-full bg-indigo-100 px-3 py-1 text-indigo-800 hover:bg-indigo-200 transition-all duration-300 ease-in-out">
                  CSS
            ...
            <div className="rounded-xl bg-white p-8 shadow-lg hover:scale-105 transition-all duration-300 ease-in-out">
              ...
              <ul className="space-y-2 cursor-pointer">
                <li className="flex items-center gap-2 ">
                  <span className="text-indigo-600">✨</span> <span className="hover:bg-indigo-200 transition-all duration-300 ease-in-out">코딩하기</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-indigo-600">📚</span> <span className="hover:bg-indigo-200 transition-all duration-300 ease-in-out">기술 책 읽기</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-indigo-600">🎮</span> <span className="hover:bg-indigo-200 transition-all duration-300 ease-in-out">게임하기</span>
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-indigo-600">🏃‍♂️</span> <span className="hover:bg-indigo-200 transition-all duration-300 ease-in-out">조깅하기</span>
                </li>
              </ul>
            </div>
          </div>
